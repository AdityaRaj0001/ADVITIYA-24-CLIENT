    ...
    <div className="w-[90%] mx-auto min-h-screen lg:py-[91px] py-[30px] text-white">
      <div className="">
        ...
        <div className="relative mt-20">
          ...
          <div
            className="mt-16 lg:mt-0 left-[7px] lg:absolute top-28 bottom-0 w-full"
              ...
              <div className="col-span-11 flex-col lg:flex-row flex gap-5">
                ...
                <div>
                  ...
                  <p className="text-sm pt-3">
                    ...
                    to the technical culture of IIT Ropar. The main objective of
                    which is developing and nurturing younger minds of the
                    country at the grassroots level.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-12 pb-[40px]">
              ...
              <div className="col-span-11 flex-col lg:flex-row flex gap-5">
                ...
                <div>
                  ...
                  <p className="text-sm pt-3">
                    The competition provides a platform for students to design
                    and construct their own gripper bot which can drive through
                    an obstacle-filled path and put the objects in the
                    respective target zones. It also provides an opportunity for
                    students to work as a team and test their skills
                  </p>
                </div>
              </div>
            </div>
