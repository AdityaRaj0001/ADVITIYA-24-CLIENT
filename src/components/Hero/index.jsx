...
const Index = ({maintext,subtext}) => {
  ...
  return (
    ...
    >
      <div id="hero" className="relative flex items-center justify-center xl:w-[100vw] h-[100%]">
        <div
          ...
          id="heromain"
        >
          <h1 className={`${maintext.length >10 ? "text-3xl sm:text-5xl  text-center  md:text-6xl lg:text-6xl font-bold herotext":"text-4xl sm:text-6xl  text-center  md:text-7xl lg:text-8xl xl:text-7xl font-bold herotext"}`}>
            {maintext}
          </h1>
