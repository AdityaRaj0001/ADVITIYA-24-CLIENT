  ...
  return (
    <>
      ...
      >
        <img
          src="Layer_1.svg"
          className="absolute z-10 pointer-events-none asset top-0  left-0 h-[200px] md:h-[280px]  xl:h-[340px]"
        />
        <img
          src="Ellipse 22.svg"
          className="absolute z-10  pointer-events-none asset top-0 left-0 h-[260px] md:h-[340px] xl:h-[420px]"
        />
        <div
          id="left"
          className="w-full bg-[#12121c]  bg-cover sm:bg-none bg-center md:bg-[url('https://cdn.dribbble.com/users/507150/screenshots/5380757/media/de2a1b1bafe3c7693b7f98362c933e66.gif')]  h-screen absolute  md:static md:w-1/2 "
        ></div>
        <div
          id="right"
          className="w-full  z-10  flex flex-col items-center justify-center md:w-1/2 "
        >
            ...
            <CardContent className="grid gap-4">
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-background px-2 text-muted-foreground bg-[#12121c]">
                    Or continue with
                  </span>
                </div>
              </div> */}
              ...
              <div className="grid gap-2">
                ...
                <div className="flex items-center relative">
                  ...
                  />
                  <div
                    className="showpass right-2 text-black absolute cursor-pointer"
